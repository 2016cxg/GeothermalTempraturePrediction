...
class pic14process:public picprocess{

public :
    pic14process(string imgpth, string outpth_):picprocess(imgpth, outpth_){
    ...
    void construct(string imgpth, string outpth_ ){
        ...
        tmplabel=0 ,tmpnum=7 ,tmpdepth=-3500 ,tmpinc = 500 ;
        dfs_idxdpth(tmplabel,tmpnum,vect,tmpdepth,tmpinc, vect[tmplabel][0] ) ;
        tmplabel=7 ,tmpnum=3 ,tmpdepth=-1000 ,tmpinc = -500 ;
        dfs_idxdpth(tmplabel,tmpnum,vect,tmpdepth,tmpinc, vect[tmplabel][0] ) ;
        tmplabel=10 ,tmpnum=1,tmpdepth=-1000 ,tmpinc = 500 ;
        dfs_idxdpth(tmplabel,tmpnum,vect,tmpdepth,tmpinc, vect[tmplabel][0] ) ;
