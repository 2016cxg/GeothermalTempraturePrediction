...
int main(){
    ...
    string imgpth="D:\\workplace\\geoproject\\pictureproject\\data\\deepth\\4binarypic\\"+to_string(data.num)+".png" ;
    string outpth="D:\\workplace\\geoproject\\pictureproject\\data\\deepth\\5cleanedOutputpic\\"+to_string(data.num)+".png" ;
